...
var locale = _interopRequireWildcard(__webpack_require__(72));

var _this = void 0;

var logger = __webpack_require__(0).get("iview:API");
...
var _default = {
  ...
  lang: function lang(code) {
    ...
    if (code === langObject.i.locale) {
      ...
      logger.warn("The ".concat(code, " language pack is not loaded."));
    }
  }.bind(void 0)
};
exports.default = _default;
...
var vClickOutside = _interopRequireWildcard(__webpack_require__(82));
